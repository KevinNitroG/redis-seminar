import{p as U}from"./chunk-WASTHULE-BoyDVCwx.js";import{p as K}from"./treemap-KZPCXAKY-L5K4MMMF-M3KFNVvF.js";import{g as Q,s as V,a as Z,b as j,x as q,v as H,c as s,l as w,d as J,I as X,aP as Y,aQ as ee,aR as G,aS as te,f as ae,C as re,aT as ie,K as se}from"./Mermaid.vue_vue_type_script_setup_true_lang-icStzxQo.js";import"./chunk-MFRUYFWM-D6inDpwX.js";import"./index-BjyMsUYc.js";import"./modules/vue-DI7rn9tG.js";import"./modules/shiki-Bmceg19b.js";import"./modules/file-saver-B7oFTzqn.js";var le=se.pie,C={sections:new Map,showData:!1},g=C.sections,D=C.showData,oe=structuredClone(le),ne=s(()=>structuredClone(oe),"getConfig"),ce=s(()=>{g=new Map,D=C.showData,re()},"clear"),de=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),pe=s(()=>g,"getSections"),ge=s(e=>{D=e},"setShowData"),ue=s(()=>D,"getShowData"),P={getConfig:ne,clear:ce,setDiagramTitle:H,getDiagramTitle:q,setAccTitle:j,getAccTitle:Z,setAccDescription:V,getAccDescription:Q,addSection:de,getSections:pe,setShowData:ge,getShowData:ue},fe=s((e,a)=>{U(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),he={parse:s(async e=>{const a=await K("pie",e);w.debug(a),fe(a,P)},"parse")},me=s(e=>`
  .pieCircle{
